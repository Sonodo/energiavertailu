  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-accent-700 transition-colors"
      >
